function encrypt() {
    ...
    var password = "MySecretPassword"; // Kunci enkripsi (ganti dengan kunci yang kuat)
...
function decrypt() {
    var inputText = document.getElementById("inputText").value;
    var password = "MySecretPassword"; // Kunci enkripsi (sama dengan yang digunakan untuk enkripsi)
